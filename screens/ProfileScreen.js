// ProfileScreen.js - Add this to display user info and sign out button
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: Colors[theme].background }]}>
      <View style={styles.profileHeader}>
        ...
        />
        <Text style={[styles.profileName, { color: Colors[theme].text }]}>{userInfo.name}</Text>
        <Text style={[styles.profileEmail, { color: Colors[theme].text }]}>{userInfo.email}</Text>
      </View>
      ...
      <View style={styles.sectionContainer}>
        ...
        <View style={[styles.infoCard, { backgroundColor: Colors[theme].cardBackground }]}>
          <View style={styles.infoRow}>
            <Text style={[styles.infoLabel, { color: Colors[theme].text }]}>Name</Text>
            <Text style={[styles.infoValue, { color: Colors[theme].text }]}>{userInfo.name}</Text>
          </View>
          <View style={styles.infoRow}>
            <Text style={[styles.infoLabel, { color: Colors[theme].text }]}>Email</Text>
            <Text style={[styles.infoValue, { color: Colors[theme].text }]}>{userInfo.email}</Text>
          </View>
          <View style={styles.infoRow}>
            <Text style={[styles.infoLabel, { color: Colors[theme].text }]}>Account Type</Text>
            <Text style={[styles.infoValue, { color: Colors[theme].text }]}>Google Account</Text>
          </View>
        </View>
      </View>
